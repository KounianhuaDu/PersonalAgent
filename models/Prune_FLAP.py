...
def compress(layer, threshold, attn_mask, mlp_mask, attn_mean_inp, mlp_mean_inp, device, bias=True, unstr=False):
    ...
    if attn_mask is not None:
        ...
        if bias:
            ...
            output_bias = ((attn_mean_inp.float() * ~attn_mask.to(device)) @ output_weight.T)
        ...
        # Update number of groups for GQA
        layer.self_attn.num_key_value_groups = retain_heads // layer.self_attn.num_key_value_heads

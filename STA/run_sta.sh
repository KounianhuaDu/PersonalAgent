...
model_name_or_path=../../model_weights/Meta-Llama-3.1-8B-Instruct # replace ./model/gemma-2-9b-it with your own model path
data_dir=../../pa_back/cluster_data
...
sae_paths=(
    ...
    ../../model_weights/sae-llama-3.1-8b-32x/layers.23.mlp 
)

suffix=16k

hook_module=resid_post
data_name=prune_python_data_rag
